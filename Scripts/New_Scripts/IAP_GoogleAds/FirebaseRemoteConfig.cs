...
public class ConfigData
{
    ...
    public int Max_Ads_View_Today = 7;
    public int Max_Request_Once = 5;
}
public class FirebaseRemoteConfig : GoogleAdsManagerAbstract
{
    ...
    {
        if (!GoogleAdsManager.Instance.CheckConnection.CheckInternetConnection()) return;
