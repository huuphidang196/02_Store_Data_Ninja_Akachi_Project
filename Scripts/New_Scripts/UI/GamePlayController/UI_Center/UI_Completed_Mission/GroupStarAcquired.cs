...
public class GroupStarAcquired : SurMonoBehaviour
{
    ...
    {
        int current_Level = GamePlayController.Instance.SystemConfig.Current_Level;
        //Set Active true star
        int count = GamePlayController.Instance.SystemConfig.GetStarMissionByLevel(current_Level) != null ?
            GamePlayController.Instance.SystemConfig.GetStarMissionByLevel(current_Level).Count_Star_Acquired : 0;
